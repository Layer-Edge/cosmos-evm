...
func NewErc20GenesisState() *erc20types.GenesisState {
	...
	erc20GenState.TokenPairs = config.TokenPairs
	erc20GenState.Params.NativePrecompiles = append(erc20GenState.Params.NativePrecompiles, config.WEVMOSContractMainnet)

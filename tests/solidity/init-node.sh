...
CHAINID="${CHAIN_ID:-cosmos_4207-1}"
...
# Change parameter token denominations to edgen
...
evmd genesis add-genesis-account "$(evmd keys show "$VAL_KEY" -a --keyring-backend "$KEYRING" --home "$CHAINDIR")" 100000000000000000000000000edgen --keyring-backend "$KEYRING" --home "$CHAINDIR"
evmd genesis add-genesis-account "$(evmd keys show "$USER1_KEY" -a --keyring-backend "$KEYRING" --home "$CHAINDIR")" 1000000000000000000000edgen --keyring-backend "$KEYRING" --home "$CHAINDIR"
evmd genesis add-genesis-account "$(evmd keys show "$USER2_KEY" -a --keyring-backend "$KEYRING" --home "$CHAINDIR")" 1000000000000000000000edgen --keyring-backend "$KEYRING" --home "$CHAINDIR"
evmd genesis add-genesis-account "$(evmd keys show "$USER3_KEY" -a --keyring-backend "$KEYRING" --home "$CHAINDIR")" 1000000000000000000000edgen --keyring-backend "$KEYRING" --home "$CHAINDIR"
evmd genesis add-genesis-account "$(evmd keys show "$USER4_KEY" -a --keyring-backend "$KEYRING" --home "$CHAINDIR")" 1000000000000000000000edgen --keyring-backend "$KEYRING" --home "$CHAINDIR"
...
evmd genesis gentx "$VAL_KEY" 1000000000000000000000edgen --gas-prices ${BASEFEE}edgen --keyring-backend "$KEYRING" --chain-id "$CHAINID" --home "$CHAINDIR"

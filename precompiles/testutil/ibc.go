...
var (
	...
	UAtomDenom    = transfertypes.NewDenom("aedgen", transfertypes.NewHop(transfertypes.PortID, "channel-0"))
	UAtomIbcDenom = UatomDenom.IBCDenom()
	...
	AatomDenom    = transfertypes.NewDenom("aedgen", transfertypes.NewHop(transfertypes.PortID, "channel-0"))

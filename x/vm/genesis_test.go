...
func TestExportGenesis(t *testing.T) {
	...
	require.Len(t, genState.Accounts, 3, "expected 3 smart contracts in the exported genesis") // NOTE: 2 deployed above + 1 for the aedgen denomination ERC-20 pair
	...
	require.Contains(t, genAddresses, testconstants.WEVMOSContractMainnet, "expected mainnet aedgen contract address in exported genesis")
}
